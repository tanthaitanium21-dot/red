...
document.querySelectorAll('.accordion-btn').forEach(btn => {
  btn.addEventListener('click', () => {
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        const appData = {
            // (ลบข้อมูลจังหวัด, โซน, และ mainCableSpecs_v5_1 ที่ไม่ได้ใช้ออก)
            
            // ฐานข้อมูล Task (เหลือเฉพาะที่ใช้)
            "electrical_installation_data": [
                {
                    "category_id": "17.0", "category_name": "งานเมนภายนอก", "tasks": [
                        ...
                        // อัปเดต: แยกแร็ค 1 และ 2 ชุด
                        { "task_id": "17.4-1", "task_name": "ติดตั้งแร็ค 1 ชุด", "unit_of_measure": "ชุด", "labor_components": [{ "labor_id": "L-RACK-INSTALL-1SET" }], "material_components": [{ "material_id": "M-RACK-1SET" }] },
                        { "task_id": "17.4-2", "task_name": "ติดตั้งแร็ค 2 ชุด", "unit_of_measure": "ชุด", "labor_components": [{ "labor_id": "L-RACK-INSTALL-2SET" }], "material_components": [{ "material_id": "M-RACK-2SET" }] },

                        // อัปเดต: ตรรกะสายเมน (แยกค่าแรงตามขนาด)
                        { 
                            "task_id": "17.5", 
                            "task_name": "เดินสายเมน (L, N)", // ชือ่จะถูก override
                            "unit_of_measure": "เมตร", 
                            "labor_components": [
                                // ตรรกะนี้จะถูก override ใน calculateCosts
                                // แต่ใส่ placeholder ไว้เพื่อสร้าง allItems
                                {"labor_id": "L-MAIN-THW-4"}, {"labor_id": "L-MAIN-THW-10"}, {"labor_id": "L-MAIN-THW-16"}, {"labor_id": "L-MAIN-THW-25"}, {"labor_id": "L-MAIN-THW-35"}, {"labor_id": "L-MAIN-THW-50"},
                                {"labor_id": "L-MAIN-THW-A-4"}, {"labor_id": "L-MAIN-THW-A-10"}, {"labor_id": "L-MAIN-THW-A-16"}, {"labor_id": "L-MAIN-THW-A-25"}, {"labor_id": "L-MAIN-THW-A-35"}, {"labor_id": "L-MAIN-THW-A-50"}
                            ], 
                            "material_components": [
                                // อัปเดต: เพิ่มสายที่ขาดหาย
                                {"material_id": "M-CABLE-THW-4"}, {"material_id": "M-CABLE-THW-10"}, {"material_id": "M-CABLE-THW-16"}, {"material_id": "M-CABLE-THW-25"}, {"material_id": "M-CABLE-THW-35"}, {"material_id": "M-CABLE-THW-50"},
                                {"material_id": "M-CABLE-THW-A-4"}, {"material_id": "M-CABLE-THW-A-10"}, {"material_id": "M-CABLE-THW-A-16"}, {"material_id": "M-CABLE-THW-A-25"}, {"material_id": "M-CABLE-THW-A-35"}, {"material_id": "M-CABLE-THW-A-50"}
                            ]
                        }
                    ]}
            ],
            
            // ฐานข้อมูลราคา (อัปเดตตรรกะค่าแรง)
            "priceList": {
                "L-POLE-6.0M": 950,
                "L-POLE-7.0M": 1025,
                "L-POLE-8.0M": 1100,
                ...
                // อัปเดต: รหัสค่าแรงและวัสดุแร็ค
                "L-RACK-INSTALL-1SET": 100,
                "L-RACK-INSTALL-2SET": 150,
                "M-RACK-1SET": 150,
                "M-RACK-2SET": 300,

                // === อัปเดต: ราคาวัสดุ (จาก Proxy Price และคงราคาเดิม) ===
                "M-CABLE-THW-4": 20,
                "M-CABLE-THW-10": 45,
                "M-CABLE-THW-16": 75,
                "M-CABLE-THW-25": 110,
                "M-CABLE-THW-35": 150,
                "M-CABLE-THW-50": 180, // เพิ่ม

                "M-CABLE-THW-A-4": 6.50, // ราคา proxy
                "M-CABLE-THW-A-10": 8.55,
                "M-CABLE-THW-A-16": 11.60,
                "M-CABLE-THW-A-25": 17.11,
                "M-CABLE-THW-A-35": 22.11,
                "M-CABLE-THW-A-50": 29.80,

                // === อัปเดต: ค่าแรงแยกตามขนาดสาย (ราคาเริ่มต้น) ===
                "L-MAIN-THW-4": 15,
                "L-MAIN-THW-10": 18,
                "L-MAIN-THW-16": 20,
                "L-MAIN-THW-25": 22,
            ...
            const appData = {
                ...
                "electrical_installation_data": [
                    ...
                    { "category_id": "5.0", "category_name": "งานติดตั้งเครื่องใช้ไฟฟ้า", "tasks": [
                        ...
                        { "task_id": "5.2", "task_name": "เดินสายไฟสำหรับเครื่องปรับอากาศ (: ซ่อน)", "unit_of_measure": "เมตร", "labor_components": [{"labor_id": "L-AC-WIRING"}], "material_components": [{"material_id": "M-WIRE-THW-4.0-BRN"}, {"material_id": "M-WIRE-THW-4.0-BLU"}, {"material_id": "M-WIRE-THW-2.5-GRN"}] },
